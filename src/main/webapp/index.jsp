...
<div class="container">
    ...
    <div class="col-md-4">
        <h2>Add Student:</h2>
        <form method="POST" action="${pageContext.request.contextPath}/controller?action=addStudent" onsubmit="return validate();">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-danger" href="${pageContext.request.contextPath}/controller?action=getStudents">Load Students!</a>
                <a class="btn btn-danger" href="${pageContext.request.contextPath}/controller?action=getBadStudents">Get Bad Students!</a>
            </div>
        </form>
    </div>
                ...
                <c:forEach items="${requestScope.students}" var="student">
                    <c:if test="${requestScope.badIds.contains(student.id)}">
                        <tr>
                            ...
                            <td><a href="${pageContext.request.contextPath}/controller?action=deleteStudent&id=${student.id}">x</a></td>
                        </tr>
                    </c:if>
                </c:forEach>
            </table>
